"""
Script from https://github.com/UKPLab/acl2017-neural_end2end_am/blob/master/progs/Brat2ConllConverter/merge_conll.py
"""
# %%
import os
import sys
...
conll_folder = 'data/AM/persuasive/test'
outfile = sys.argv[2]

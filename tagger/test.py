...
if __name__ == "__main__":
    ...
    datasets_bank.add_train_sequences(word_sequences, targets_tag_sequences_test)

    word_seq_indexer = SeqIndexerWord(gpu=args.gpu, check_for_lowercase=True,
                                          embeddings_dim=args.emb_dim, skip_first=True, verbose=True)
    ...
    # Load tagger model
    tagger = TaggerFactory.load(args.load, args.gpu, word_seq_indexer)
